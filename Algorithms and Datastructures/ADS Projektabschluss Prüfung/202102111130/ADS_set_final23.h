...
public:
  ...
  explicit Iterator(Node* e = nullptr, Hashtable* table = nullptr, size_type index = 0, size_type row_count = N, bool special_mode = false, size_type number_elements = 0, size_type first_index = 0) {
    this->e = e;
    this->table = table;
    this->index = index;
