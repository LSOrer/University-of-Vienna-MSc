...
public:
  ...
  explicit Iterator(Node* e = nullptr, Hashtable* table = nullptr, size_type index = 0, size_type row_count = N) : e{e}, table{table}, index{index}, row_count{row_count} {}
