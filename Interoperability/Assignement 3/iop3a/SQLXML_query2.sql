...
SELECT xmlroot(
		xmlelement(name order_data_all,
			xmlagg(
       			xmlelement(name order_meta, xmlforest(o.order_date, o.order_id, o.orderdetail),
				 		xmlelement(name orderitems, xmlforest(oi.itname, oi.itsize, oi.itcost)),
							xmlelement(name ingredients, xmlforest(i.inname, i.inalergic, i.intype)))))
